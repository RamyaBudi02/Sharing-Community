...
<body>
    ...
    <div class="search-boxes">
        ...
        <div class="search-box2">
            <input type="text" placeholder="Search item" id="search" name="search" class="item-search">
        ...
        <div class="up1">
             <img src="search.png" href="categoryview1.php"></a>
        </div>
    </div>
...
<a href="#">Gwalior</a>
    ...
    //$cat = filter_input(INPUT_POST, 'category', FILTER_SANITIZE_STRING);
       ...
       //echo '<script type="text/javascript">
              ...
              /*  echo '<script type="text/javascript">
                             window.location.href = "categoryview1.php";
                         </script>';*/
      }
           ?>
